...
const double CRITICAL_T		[MAX_SUB]=  {154.7,		33.2,		647.3,		126.2,		304.4,		645,			607.15,			431.15,			5.19		};		//K.. critical temperature
...
{public:
	...
	double RemoveLiquidMass(double grams); //useful for propellant tanks and pumping out of a sump under aceleration
