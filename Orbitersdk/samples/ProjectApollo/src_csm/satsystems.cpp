...
void Saturn::SystemsInit() {
	...
	FuelCellStartupHeaters[0] = (Boiler *)Panelsdk.GetPointerByString("ELECTRIC:FUELCELL1HEATER");
	FuelCellStartupHeaters[1] = (Boiler *)Panelsdk.GetPointerByString("ELECTRIC:FUELCELL2HEATER");
	FuelCellStartupHeaters[2] = (Boiler *)Panelsdk.GetPointerByString("ELECTRIC:FUELCELL3HEATER");
	...
	FuelCellO2Chamber[0] = (h_Tank *)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL1CHAMBER");
	FuelCellO2Chamber[1] = (h_Tank *)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL2CHAMBER");
	FuelCellO2Chamber[2] = (h_Tank *)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL3CHAMBER");
	...
	FuelCellO2FlowRate[0] = (double *)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL1SUPPLYREGULATOR:AVGFLOW");
	FuelCellO2FlowRate[1] = (double *)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL2SUPPLYREGULATOR:AVGFLOW");
	FuelCellO2FlowRate[2] = (double *)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL3SUPPLYREGULATOR:AVGFLOW");

	FuelCellH2FlowRate[0] = (double *)Panelsdk.GetPointerByString("HYDRAULIC:H2FUELCELL1SUPPLYREGULATOR:AVGFLOW");
	...
	CoolantPipeRad_5_6[2] = (h_Pipe*)Panelsdk.GetPointerByString("HYDRAULIC:EPSRADIATOR1TO5-6TO8TUBE3");

	FuelCellCoolantOutletTemp[0] = (double*)Panelsdk.GetPointerByString("HYDRAULIC:FUELCELL1REGEN:TEMP");
	FuelCellCoolantOutletTemp[1] = (double*)Panelsdk.GetPointerByString("HYDRAULIC:FUELCELL2REGEN:TEMP");
	FuelCellCoolantOutletTemp[2] = (double*)Panelsdk.GetPointerByString("HYDRAULIC:FUELCELL3REGEN:TEMP");

	EPSRadiator5OutletValve[0] = (h_Valve*)Panelsdk.GetPointerByString("HYDRAULIC:EPSRADIATOR1TO5TUBE1:OUT");
	EPSRadiator5OutletValve[1] = (h_Valve*)Panelsdk.GetPointerByString("HYDRAULIC:EPSRADIATOR1TO5TUBE2:OUT");
	EPSRadiator5OutletValve[2] = (h_Valve*)Panelsdk.GetPointerByString("HYDRAULIC:EPSRADIATOR1TO5TUBE3:OUT");

	EPSRadiator6InletValve[0] = (h_Valve*)Panelsdk.GetPointerByString("HYDRAULIC:EPSRADIATOR6TO8TUBE1:IN");
	EPSRadiator6InletValve[1] = (h_Valve*)Panelsdk.GetPointerByString("HYDRAULIC:EPSRADIATOR6TO8TUBE2:IN");
	EPSRadiator6InletValve[2] = (h_Valve*)Panelsdk.GetPointerByString("HYDRAULIC:EPSRADIATOR6TO8TUBE3:IN");

	EPSRadiator8OutletValve[0] = (h_Valve*)Panelsdk.GetPointerByString("HYDRAULIC:EPSRADIATOR6TO8TUBE1:OUT");
	EPSRadiator8OutletValve[1] = (h_Valve*)Panelsdk.GetPointerByString("HYDRAULIC:EPSRADIATOR6TO8TUBE2:OUT");
	EPSRadiator8OutletValve[2] = (h_Valve*)Panelsdk.GetPointerByString("HYDRAULIC:EPSRADIATOR6TO8TUBE3:OUT");
...
void Saturn::SystemsTimestep(double simt, double simdt, double mjd) {
		...
		if (!firstSystemsTimeStepDone) {
			...
			case SATSYSTEMS_GSECONNECTED_1:
				if (MissionTime >= -900) {	// 15min before launch
					...
					FuelCellStartupHeaters[0]->Disable();
					FuelCellStartupHeaters[1]->Disable();
					FuelCellStartupHeaters[2]->Disable();
	...
	//sprintf(oapiDebugString(), "FC1 O2 PRESS %0.2f, FC2 O2 PRESS %0.2f, FC3 O2 PRESS %0.2f, FC1 H2 PRESS %0.2f, FC2 H2 PRESS %0.2f, FC3 H2 PRESS %0.2f",
	//	*(double*)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL1MANIFOLD:PRESS"),
	//	*(double*)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL2MANIFOLD:PRESS"),
	//	*(double*)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL3MANIFOLD:PRESS"),
	//	*(double*)Panelsdk.GetPointerByString("HYDRAULIC:H2FUELCELL1MANIFOLD:PRESS"),
	//	*(double*)Panelsdk.GetPointerByString("HYDRAULIC:H2FUELCELL2MANIFOLD:PRESS"),
	//	*(double*)Panelsdk.GetPointerByString("HYDRAULIC:H2FUELCELL3MANIFOLD:PRESS"));
	...
	for (int fc2log = 0; fc2log < 3; fc2log++)
	{
		...
		fprintf(FuelCellLogFile[fc2log], "%0.5f, %0.5f, %0.5f, %0.5f, %0.5f, %0.5f, %0.5f, %0.5f, %0.5f, %0.5f, %0.5f, %0.5f, %0.5f, %0.5f\n",
			simt,
			FCstatLog.CondenserTempF,
			FCstatLog.CoolingTempF,
			FCstatLog.Current,
			FCstatLog.H2FlowLBH,
			FCstatLog.H2PressurePSI,
			FCstatLog.NitrogenAtmPressure,
			FCstatLog.O2FlowLBH,
			FCstatLog.O2PressurePSI,
			FCstatLog.PowerOutput,
			FCstatLog.RadiatorTempInF,
			FCstatLog.RadiatorTempOutF,
			FCstatLog.TempF,
			FCstatLog.Voltage);
