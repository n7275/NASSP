				...
				case 11: // S11A
					switch(ccode){
						...
						case 29:		// FC 1 N2 PRESS
							scale_data(sat->FCN2PressureSensor1.Voltage(), 0.0, 5.0);
						case 30:		// FC 2 N2 PRESS
							scale_data(sat->FCN2PressureSensor2.Voltage(), 0.0, 5.0);
						...
						case 35:		// FC 3 N2 PRESS
							scale_data(sat->FCN2PressureSensor3.Voltage(), 0.0, 5.0);
